...
public interface NguoiDungRepository extends CrudRepository<Nguoidung, Long>{
	...
	@Query(value = "SELECT id, manguoidung, tennguoidung, password, email, gender, phone, createday, nguoitao, updateday, nguoiupdate, isdelete, enabled from qtht_nguoidung where isdelete = 0", nativeQuery = true)
